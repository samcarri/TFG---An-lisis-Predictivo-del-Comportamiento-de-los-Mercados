...
Random Forest base con datos financieros + features de noticias (GDELT).
Dataset: data/dataset_nvda_news.csv

Output:
  scripts/news/outputs/random_forest/rf_news_results.csv
  scripts/news/outputs/random_forest/rf_news_plot.png
  trained_models/rf_news_model.joblib
  trained_models/rf_news_scaler.joblib
"""
...
OUTPUT_CSV   = "scripts/news/outputs/random_forest/rf_news_results.csv"
OUTPUT_PLOT  = "scripts/news/outputs/random_forest/rf_news_plot.png"
OUTPUT_MODEL = "trained_models/rf_news_model.joblib"
OUTPUT_SCALER= "trained_models/rf_news_scaler.joblib"
STEP         = 10
RANDOM_STATE = 42
...
def main():
    ...
    print("=" * 60)
    print("RANDOM FOREST BASE — DATOS FINANCIEROS + NOTICIAS")
    print("=" * 60)
    ...
    for _, row in imp.head(10).iterrows():
        ...
        print(f"  {row['feature']:30s} {row['importance']:.5f}  {bar}")
    ...
    axes[0].set_title("Random Forest News — Feature Importance", fontweight="bold")
