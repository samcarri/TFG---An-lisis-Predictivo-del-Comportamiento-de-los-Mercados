...
LightGBM base con datos financieros + features de noticias (GDELT).
Dataset: data/dataset_nvda_news.csv

Output:
  scripts/news/outputs/lightGBM/lgbm_news_results.csv
  scripts/news/outputs/lightGBM/lgbm_news_plot.png
  trained_models/lgbm_news_model.joblib
  trained_models/lgbm_news_scaler.joblib
"""
...
OUTPUT_CSV   = "scripts/news/outputs/lightGBM/lgbm_news_results.csv"
OUTPUT_PLOT  = "scripts/news/outputs/lightGBM/lgbm_news_plot.png"
OUTPUT_MODEL = "trained_models/lgbm_news_model.joblib"
OUTPUT_SCALER= "trained_models/lgbm_news_scaler.joblib"
STEP         = 10
RANDOM_STATE = 42
...
def main():
    ...
    print("=" * 60)
    print("LIGHTGBM BASE — DATOS FINANCIEROS + NOTICIAS")
    print("=" * 60)
    ...
    axes[0].set_title("LightGBM News — Feature Importance", fontweight="bold")
