...
LSTM base con datos financieros + features de noticias (GDELT).
Dataset: data/dataset_nvda_news.csv
Arquitectura: 2 capas LSTM + Dropout. Idéntica a lstm_financial pero con 44 features.

Output:
  scripts/news/outputs/lstm/lstm_news_results.csv
  scripts/news/outputs/lstm/lstm_news_plot.png
"""
...
OUTPUT_CSV  = "scripts/news/outputs/lstm/lstm_news_results.csv"
OUTPUT_PLOT = "scripts/news/outputs/lstm/lstm_news_plot.png"
...
def main():
    ...
    print("=" * 60)
    print(f"LSTM BASE — DATOS FINANCIEROS + NOTICIAS  (time_steps={TIME_STEPS})")
    print("=" * 60)
    ...
    axes[0].set_title("LSTM News — Loss durante entrenamiento", fontweight="bold")
