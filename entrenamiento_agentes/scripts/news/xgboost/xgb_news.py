...
XGBoost base con datos financieros + features de noticias (GDELT).
Dataset: data/dataset_nvda_news.csv

Output:
  scripts/news/outputs/xgboost/xgb_news_results.csv
  scripts/news/outputs/xgboost/xgb_news_plot.png
  trained_models/xgb_news_model.joblib
  trained_models/xgb_news_scaler.joblib
"""
...
OUTPUT_CSV   = "scripts/news/outputs/xgboost/xgb_news_results.csv"
OUTPUT_PLOT  = "scripts/news/outputs/xgboost/xgb_news_plot.png"
OUTPUT_MODEL = "trained_models/xgb_news_model.joblib"
OUTPUT_SCALER= "trained_models/xgb_news_scaler.joblib"
STEP         = 10
RANDOM_STATE = 42
...
def main():
    ...
    print("=" * 60)
    print("XGBOOST BASE — DATOS FINANCIEROS + NOTICIAS")
    print("=" * 60)
    ...
    axes[0].set_title("XGBoost News — Feature Importance", fontweight="bold")
