...
Random Forest base con datos puramente financieros (Yahoo Finance).
Sin noticias, sin Reddit.

Output:
  scripts/financial/outputs/random_forest/rf_financial_results.csv
  scripts/financial/outputs/random_forest/rf_financial_plot.png
"""
...
OUTPUT_CSV  = "scripts/financial/outputs/random_forest/rf_financial_results.csv"
OUTPUT_PLOT = "scripts/financial/outputs/random_forest/rf_financial_plot.png"
STEP        = 10
...
def main():
    ...
    print("=" * 60)
    print("RANDOM FOREST BASE — DATOS FINANCIEROS")
    print("=" * 60)
    ...
    axes[0].set_title("Random Forest Financial — Feature Importance", fontweight="bold")
