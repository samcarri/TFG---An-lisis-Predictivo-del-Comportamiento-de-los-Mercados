...
Random Forest para predicción a 1 mes (21 días hábiles) con datos financieros.

Output:
  scripts/financial/outputs/monthly/rf_monthly_results.csv
  scripts/financial/outputs/monthly/rf_monthly_plot.png
"""
...
OUTPUT_CSV  = "scripts/financial/outputs/monthly/rf_monthly_results.csv"
OUTPUT_PLOT = "scripts/financial/outputs/monthly/rf_monthly_plot.png"
MODEL_PATH  = "trained_models/rf_monthly_model.joblib"
SCALER_PATH = "trained_models/rf_monthly_scaler.joblib"
...
def main():
    ...
    print("=" * 60)
    print(f"RANDOM FOREST MONTHLY — PREDICCIÓN A {PREDICTION_HORIZON} DÍAS")
    print("=" * 60)
    ...
    axes[0].set_title(f"Random Forest Monthly ({PREDICTION_HORIZON}d) — Feature Importance", fontweight="bold")
