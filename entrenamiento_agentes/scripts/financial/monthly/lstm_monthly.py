...
LSTM para predicción a 1 mes (21 días hábiles) con datos financieros.
Predice si el precio subirá en los próximos 21 días.

Output:
  scripts/financial/outputs/monthly/lstm_monthly_results.csv
  scripts/financial/outputs/monthly/lstm_monthly_plot.png
"""
...
OUTPUT_CSV  = "scripts/financial/outputs/monthly/lstm_monthly_results.csv"
OUTPUT_PLOT = "scripts/financial/outputs/monthly/lstm_monthly_plot.png"

PREDICTION_HORIZON = 21  # 1 mes = ~21 días hábiles
TIME_STEPS   = 15
EPOCHS       = 100
BATCH_SIZE   = 32
RANDOM_STATE = 42
...
def main():
    ...
    print("=" * 60)
    print(f"LSTM MONTHLY — PREDICCIÓN A {PREDICTION_HORIZON} DÍAS (time_steps={TIME_STEPS})")
    print("=" * 60)
    ...
    MODEL_PATH = "trained_models/lstm_monthly_model.h5"
    SCALER_PATH = "trained_models/lstm_monthly_scaler.joblib"
