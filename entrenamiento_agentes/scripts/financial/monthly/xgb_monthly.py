...
Output:
  scripts/financial/outputs/monthly/xgb_monthly_results.csv
  scripts/financial/outputs/monthly/xgb_monthly_plot.png
"""
...
OUTPUT_CSV  = "scripts/financial/outputs/monthly/xgb_monthly_results.csv"
OUTPUT_PLOT = "scripts/financial/outputs/monthly/xgb_monthly_plot.png"
MODEL_PATH  = "trained_models/xgb_monthly_model.joblib"
SCALER_PATH = "trained_models/xgb_monthly_scaler.joblib"
PREDICTION_HORIZON = 21
STEP        = 10
RANDOM_STATE = 42


def load_data(path, horizon=21):
    df = pd.read_csv(path)
...
def main():
    ...
    print("=" * 60)
    print(f"XGBOOST MONTHLY — PREDICCIÓN A {PREDICTION_HORIZON} DÍAS")
    print("=" * 60)
