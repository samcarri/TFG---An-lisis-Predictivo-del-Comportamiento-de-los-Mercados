...
Regresión Logística base con datos puramente financieros (Yahoo Finance).
Sin noticias, sin Reddit.

Output:
  scripts/financial/outputs/lineal_regression/lr_financial_results.csv
  scripts/financial/outputs/lineal_regression/lr_financial_plot.png
"""
...
OUTPUT_CSV  = "scripts/financial/outputs/lineal_regression/lr_financial_results.csv"
OUTPUT_PLOT = "scripts/financial/outputs/lineal_regression/lr_financial_plot.png"
...
def main():
    ...
    print("=" * 60)
    print("REGRESIÓN LOGÍSTICA BASE — DATOS FINANCIEROS")
    print("=" * 60)
    ...
    for _, row in imp.head(10).iterrows():
        ...
        print(f"  {row['feature']:25s} {row['coef_abs']:.4f}  {bar}")
    ...
    axes[0].set_title("Regresión Logística Financial — Coeficientes", fontweight="bold")
