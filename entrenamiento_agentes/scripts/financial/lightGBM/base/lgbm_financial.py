...
LightGBM base con datos puramente financieros (Yahoo Finance).
Sin noticias, sin Reddit.

Output:
  scripts/financial/outputs/lightGBM/lgbm_financial_results.csv
  scripts/financial/outputs/lightGBM/lgbm_financial_plot.png
"""
...
OUTPUT_CSV  = "scripts/financial/outputs/lightGBM/lgbm_financial_results.csv"
OUTPUT_PLOT = "scripts/financial/outputs/lightGBM/lgbm_financial_plot.png"
STEP        = 10
...
def main():
    ...
    print("=" * 60)
    print("LIGHTGBM BASE — DATOS FINANCIEROS")
    print("=" * 60)
    ...
    axes[0].set_title("LightGBM Financial — Feature Importance", fontweight="bold")
