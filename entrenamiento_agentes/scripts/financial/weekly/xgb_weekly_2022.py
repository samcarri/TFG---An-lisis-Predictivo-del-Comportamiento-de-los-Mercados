...
XGBoost para predicción a 1 semana (5 días hábiles) con datos financieros.

Output:
  scripts/financial/outputs/weekly/xgb_weekly_results.csv
  scripts/financial/outputs/weekly/xgb_weekly_plot.png
"""
...
OUTPUT_CSV  = "scripts/financial/outputs/weekly/xgb_weekly_results.csv"
OUTPUT_PLOT = "scripts/financial/outputs/weekly/xgb_weekly_plot.png"
MODEL_PATH  = "trained_models/xgb_weekly_model.joblib"
SCALER_PATH = "trained_models/xgb_weekly_scaler.joblib"
...
def main():
    ...
    print("=" * 60)
    print(f"XGBOOST WEEKLY — PREDICCIÓN A {PREDICTION_HORIZON} DÍAS")
    print("=" * 60)
    ...
    axes[0].set_title(f"XGBoost Weekly ({PREDICTION_HORIZON}d) — Feature Importance", fontweight="bold")
