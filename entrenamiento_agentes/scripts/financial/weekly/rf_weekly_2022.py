...
Random Forest para predicción a 1 semana (5 días hábiles) con datos desde 2022.

Output:
  scripts/financial/outputs/weekly/rf_weekly_2022_results.csv
  scripts/financial/outputs/weekly/rf_weekly_2022_plot.png
"""
...
OUTPUT_CSV  = "scripts/financial/outputs/weekly/rf_weekly_2022_results.csv"
OUTPUT_PLOT = "scripts/financial/outputs/weekly/rf_weekly_2022_plot.png"
MODEL_PATH  = "trained_models/rf_weekly_2022_model.joblib"
SCALER_PATH = "trained_models/rf_weekly_2022_scaler.joblib"
PREDICTION_HORIZON = 5
STEP        = 10
RANDOM_STATE = 42


def load_data(path, horizon=5, start_date="2022-01-01"):
    df = pd.read_csv(path)
...
def main():
    ...
    print("=" * 60)
    print(f"RANDOM FOREST WEEKLY 2022 — PREDICCIÓN A {PREDICTION_HORIZON} DÍAS")
    print("=" * 60)
